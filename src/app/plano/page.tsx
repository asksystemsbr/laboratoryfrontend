  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="container mx-auto p-8">
        ...
        >
          {isEditing ? (
            <PlanoEditForm plano={editingItem!} onSave={handleSave} onClose={() => setModalIsOpen(false)} setSnackbar={setSnackbar} />
          ) : (
            <PlanoCreateForm onSave={handleSave} onClose={() => setModalIsOpen(false)} setSnackbar={setSnackbar} />
          )}
        </Modal>
