...
const PedidoPagamentosForm: React.FC<PagamentosFormProps> = ({ onPagamentosSelected,pedidosPagamentos =[],pedidoCabecalhoData,total  }) => {  
  ...
  const adicionarFormaPagamento = async (e: React.MouseEvent) => {
    ...
    try {
      ...
      const alreadyExists = (addedFormaPagamento as PedidoPagamento[]).some(
